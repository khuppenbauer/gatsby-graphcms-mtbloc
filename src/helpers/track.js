...
export const renderMetaData = (metaData) => {
  ...
  return (
    <>
      <span className="text-gray-500 inline-flex items-center mr-2 leading-none text-sm py-1">
      ...
      <span className="text-gray-500 inline-flex items-center leading-none text-sm py-1">
